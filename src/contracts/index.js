...
export const whaleyNFTContractAbi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "enum MintNewWhaleyProject.Phase",
        name: "phase",
        type: "uint8",
      },
      {
  ...
  {
    inputs: [],
    name: "mintWhaleyProject",
    outputs: [
      {
        internalType: "contract MintWhaleyProject",
        name: "",
        type: "address",
      },
    ],
...
export const testWhaleyNFTContractAbi = [
  {
    inputs: [],
    name: "advancePhase",
    outputs: [],
  ...
  },
  {
    inputs: [
      {
        internalType: "enum TestMintWhaleyProject.Phase",
        name: "phase",
        type: "uint8",
      },
      {
...
export const test2WhaleyNFTContractAbi = [
  {
    inputs: [],
    name: "advancePhase",
    outputs: [],
...
export const whaleyContract = (mode) => {
  if (mode === "test1") {
    return new web3.eth.Contract(
      testWhaleyNFTContractAbi,
      test1ContractAddress
    );
  }
  if (mode === "test2") {
    return new web3.eth.Contract(
      test2WhaleyNFTContractAbi,
